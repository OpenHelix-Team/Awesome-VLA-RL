...
| [RLinf](https://arxiv.org/pdf/2509.15965) | RLinf: Reinforcement Learning Infrastructure for Agentic AI | Arxiv | 8/2025 | [Project](https://github.com/RLinf/RLinf) | <details><summary>Details</summary>RLinf is a flexible and scalable open-source infrastructure designed for post-training foundation models via reinforcement learning. The ‘inf’ in RLinf stands for Infrastructure, highlighting its role as a robust backbone for next-generation training. It also stands for Infinite, symbolizing the system’s support for open-ended learning, continuous generalization, and limitless possibilities in intelligence development.</details> |
| [RLinf-VLA](https://arxiv.org/pdf/2510.06710v1) | RLinf-VLA: A Unified and Efficient Framework for VLA+RL Training | Arxiv | 10/2025 | [Project](https://github.com/RLinf/RLinf) | <details><summary>Details</summary> </details> |
